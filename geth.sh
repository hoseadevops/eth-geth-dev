...
start)
    ...
    run_cmd "geth --datadir=./geth/$IDENTITY --port=$PORT --rpc --rpccorsdomain '*' --rpcaddr=0.0.0.0 --rpcport=$RPC_PORT --allow-insecure-unlock --networkid=$network_id --preload=config/identities.js --nodiscover --verbosity=5 --mine --minerthreads=1 --nat=any console 2>>./geth/$IDENTITY/geth.log"
    ;;
