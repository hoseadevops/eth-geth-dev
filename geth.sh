...
start)
    ...
    run_cmd "geth --datadir=./geth/$IDENTITY --port=$PORT --rpc --rpcaddr=0.0.0.0 --rpcport=$RPC_PORT --allow-insecure-unlock --networkid=$network_id --preload=config/identities.js --nodiscover --verbosity=5 --mine --minerthreads=1 console 2>>./geth/$IDENTITY/geth.log"
    ;;
